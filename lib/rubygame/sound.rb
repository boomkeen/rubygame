...
class Rubygame::Sound
  ...
  class << self
    ...
    # Load an audio file directly from memory. This is similar to
    # #load, but it reads the data from a string instead of a file.
    # This is useful if the audio file data was already loaded,
    # received over a network, or generated by the program.
    # 
    # data:: a string containing the data for the audio file.
    # 
    # Raises:: SDLError if the audio file data cannot be loaded.
    # 
    def load_from_string( data )
      ...
      sound = SDL::Mixer.LoadWAV_RW(rw, 0)

      if sound.pointer.null?
        raise( Rubygame::SDLError,
               "Couldn't load audio from string: #{SDL.GetError()}" )
      end
